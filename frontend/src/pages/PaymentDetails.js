          ...
          <Row>
            ...
            {partialPayment === "yes" && (
              <InputField
                ...
                type="date"
                error={
                  errors.partial_payment_date &&
                  errors.partial_payment_date.message
                }
                required
              />
            )}
            ...
            <Row>
              ...
              <div
                className={`total-amount-display ${
                  isAmountSufficient ? "sufficient" : "insufficient"
                }`}
              >
  ...
  return (
    <div className="payment-details-container">
      ...
      >
        ...
        <Row>
          <div className="bus-confirmation-alt">
            <label className="bus-confirmation-alt-label">
              Bus Requirement
            </label>
            <div className="bus-confirmation-alt-container">
              <input
                type="checkbox"
                checked={busRequired}
                onChange={(e) => setBusRequired(e.target.checked)}
              />
              <span className="bus-confirmation-alt-text">Bus Required</span>
            </div>
          </div>
