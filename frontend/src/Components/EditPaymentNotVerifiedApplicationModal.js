...
function EditPaymentNotVerifiedApplicationModal({ applicationData, isOpen, setIsOpen }) {
    ...
    const onEdit = async () => {
        ...
        setIsOpen(false);
        setIsLoading(false);
        navigate('/payment_details', { state: { fromPaymentNotVerifiedApplication: true, applicationData: applicationData } });
    }
...
export default EditPaymentNotVerifiedApplicationModal
